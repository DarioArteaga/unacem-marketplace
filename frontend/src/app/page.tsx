    ...
    <>
      <section className="relative overflow-hidden bg-brand text-white">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-10">
          <p className="mb-2 text-xs font-medium tracking-wide text-white/80 uppercase">Grupo UNACEM</p>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/90 sm:text-base">
            {SITE_DESCRIPTION} Descubre cómo equipos de distintas áreas resolvieron problemas reales de su día a
            día.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-ink-muted/20 bg-surface px-3 py-1.5 text-sm font-medium text-ink transition hover:border-brand/40 hover:text-brand"
          >
